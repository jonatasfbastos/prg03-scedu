...
import br.com.ifba.curso.view.CursoListar; // Importa a classe CursoListar que representa uma tela na aplicação
...
public class Application {
    ...
    public static void main(String[] args) {
        ...
        ConfigurableApplicationContext context = 
            new SpringApplicationBuilder(Application.class) // Inicia a construção da aplicação Spring com a classe Application como base
