...
public class TelaListar extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pnlFuncoes.setBackground(new java.awt.Color(59, 89, 152));
        ...
        btnAdcionar.setBackground(new java.awt.Color(59, 89, 152));
        ...
        btnExcluir.setBackground(new java.awt.Color(59, 89, 152));
        ...
        btnProcura.setBackground(new java.awt.Color(59, 89, 152));
        ...
        pnlTabela.setBackground(new java.awt.Color(59, 89, 152));
    ...
    private void btnProcuraActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnProcuraActionPerformed
        // Obtém o nome do curso que o usuário deseja pesquisar
        ...
        try{    
            ...
            if (alunosBuscados != null) {
                ...
                DefaultTableModel dtmCursos = (DefaultTableModel) tblAlunos.getModel();
            ...
            log.error("Erro ao procurar Aluno com texto: {}", busca, e);
            JOptionPane.showMessageDialog(null, StringUtil.getFindByNameError(busca), "ERRO", JOptionPane.ERROR_MESSAGE);
        }
