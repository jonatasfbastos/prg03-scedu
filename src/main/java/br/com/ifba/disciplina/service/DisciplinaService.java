...
import br.com.ifba.disciplina.repository.DisciplinaRepository;
...
public class DisciplinaService implements DisciplinaIService{
    ...
    public Disciplina save(Disciplina disciplina) throws RuntimeException {
        ...
        if (disciplina == null) {
            throw new RuntimeException(StringUtil.getNullDisciplinaError());
        }
        // Verifica se a disciplina já existe (tem um ID)
        else if (disciplina.getId() != null) {
            throw new RuntimeException(StringUtil.getExistingDisciplinaError());
        } 
