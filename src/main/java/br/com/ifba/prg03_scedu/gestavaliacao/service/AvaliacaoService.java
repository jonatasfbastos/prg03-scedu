...
//        throw new RuntimeException(StringUtil.getNullAvaliacaoError());
    ...
    public Avaliacao update(Avaliacao avaliacao) throws RuntimeException {
            // Verifica se o objeto curso é nulo e lança uma exceção se for o caso
    if (avaliacao == null) {
        throw new RuntimeException(StringUtil.getNullAvaliacaoError());
    } else {
        // Atualiza o curso usando o cursoDao e retorna o curso atualizado
  ...
  //      log.info("Buscando os objetos curso por nome");
